...
O brinquedo SHALL organizar as bolhas em vagas que se sucedem para sempre, celebrando o fim de cada vaga, e NÃO SHALL ter pontuação, tempo limite, contagem de erros nem estado de "falhou".

#### Scenario: Fim de vaga

- **WHEN** a criança estoura a última bolha de uma vaga
- **THEN** há uma celebração curta (confetti e som de vitória) e uma nova vaga entra poucos instantes depois, com uma cor nova e formas de fogo ainda não usadas nesta sessão
...
O brinquedo SHALL decorrer debaixo de água — água clara, feixes de luz e areia no fundo — de modo que subir seja o comportamento natural das bolhas, com dois ou três peixes a nadar na cena.
